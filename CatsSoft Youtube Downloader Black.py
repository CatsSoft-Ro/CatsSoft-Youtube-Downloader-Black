...
# deschiderea/închiderea secțiunii despre autor
def toggle_author_section():
    # Folosește global pentru a face referire la variabilele definite în afara funcției
    global author_frame, author_button

    # Alternează între vizibil și ascuns pentru secțiunea despre autor
    if author_frame.winfo_ismapped():
        author_frame.pack_forget()
        author_button.configure(text="About")  # Replace config with configure
    else:
        author_frame.pack()
        author_button.configure(text="Hide")  # Replace config with configure

# Crează un buton pentru deschiderea/închiderea secțiunii despre autor
author_button = customtkinter.CTkButton(app, text="About", text_color="#F2F2F2", command=toggle_author_section)
author_button.pack(padx=10, pady=10, side="bottom", anchor="sw")

# Frame pentru secțiunea despre autor (ințial invizibilă)
author_frame = customtkinter.CTkFrame(master=app)
author_frame.pack(pady=35, padx=60, fill="both", expand=True)
author_frame.pack_forget()

# Label pentru informațiile despre autor
author_label = customtkinter.CTkLabel(author_frame, text="Author information", text_color="#F2F2F2", width=140, height=14, fg_color="#000000")
author_label.pack()

button_frame = customtkinter.CTkFrame(master=author_frame)
button_frame.pack(pady=10)

framebuttons = customtkinter.CTkFrame(master=author_frame)
framebuttons.pack(pady=30)

IMAGE_WIDTH = 20
IMAGE_HEIGHT = 20

facebook_ico = customtkinter.CTkImage(light_image=Image.open(get_image_path("images/facebook_icon.png")), size=(IMAGE_WIDTH , IMAGE_HEIGHT))
instagram_ico = customtkinter.CTkImage(light_image=Image.open(get_image_path("images/instagram_icon.png")), size=(IMAGE_WIDTH , IMAGE_HEIGHT))
whatsapp_ico = customtkinter.CTkImage(light_image=Image.open(get_image_path("images/whatsapp_icon.png")), size=(IMAGE_WIDTH , IMAGE_HEIGHT))
telegram_ico = customtkinter.CTkImage(light_image=Image.open(get_image_path("images/telegram_icon.png")), size=(IMAGE_WIDTH , IMAGE_HEIGHT))
x_ico = customtkinter.CTkImage(light_image=Image.open(get_image_path("images/x_icon.png")), size=(IMAGE_WIDTH , IMAGE_HEIGHT))

facebook_ico_button = customtkinter.CTkButton(master=framebuttons, text="Facebook", text_color="#F2F2F2", image=facebook_ico, cursor="hand2")
instagram_ico_button = customtkinter.CTkButton(master=framebuttons, text="Instagram", text_color="#F2F2F2", image=instagram_ico, cursor="hand2")
whatsapp_ico_button = customtkinter.CTkButton(master=framebuttons, text="WhatsApp", text_color="#F2F2F2", image=whatsapp_ico, cursor="hand2")
telegram_ico_button = customtkinter.CTkButton(master=framebuttons, text="Telegram", text_color="#F2F2F2", image=telegram_ico, cursor="hand2")
x_ico_button = customtkinter.CTkButton(master=framebuttons, text="X", text_color="#F2F2F2", image=telegram_ico, cursor="hand2")

facebook_ico_button.pack(side=LEFT, padx=5, pady=5)
instagram_ico_button.pack(side=LEFT, padx=5, pady=5)
whatsapp_ico_button.pack(side=LEFT, padx=5, pady=5)
telegram_ico_button.pack(side=LEFT, padx=5, pady=5)
x_ico_button.pack(side=LEFT, padx=5, pady=5)

facebook_ico_button.bind("<Button-1>", lambda e:open_url("https://www.facebook.com/adrian25prisacariu"))
instagram_ico_button.bind("<Button-1>", lambda e:open_url("https://www.instagram.com/prisacariu6"))
whatsapp_ico_button.bind("<Button-1>", lambda e:open_url("https://chat.whatsapp.com/DAuKYmTdpl4BwW7pOlUCiE"))
telegram_ico_button.bind("<Button-1>", lambda e:open_url("https://t.me/+VRhXXd8exJJmNTRk"))
x_ico_button.bind("<Button-1>", lambda e:open_url("https://x.com/AdrianPris30451"))
